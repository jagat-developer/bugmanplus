...
The service and location SEO pages are generated from shared service/location data in `scripts/build.mjs`. The current programmatic SEO focus is Durham Region, with 20 priority services mapped across 14 Durham municipalities and communities.
