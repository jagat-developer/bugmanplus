...
const serviceImages = {
  ...
  mouse: versionedAsset("/assets/images/mouse-control.jpg"),
  rat: versionedAsset("/assets/images/rat-control.jpg"),
  wasp: versionedAsset("/assets/images/wasp-nest-removal.jpg"),
  spider: versionedAsset("/assets/images/spider-control.jpg"),
  flea: versionedAsset("/assets/images/flea-control.jpg"),
  mosquito: versionedAsset("/assets/images/mosquito-control.jpg"),
  ant: versionedAsset("/assets/images/ant-control.jpg"),
  carpenterAnt: versionedAsset("/assets/images/carpenter-ant-control.jpg"),
  carpenterBee: versionedAsset("/assets/images/carpenter-bee-control.jpg"),
  cockroach: versionedAsset("/assets/images/cockroach-control.jpg"),
  fruitFly: versionedAsset("/assets/images/fruit-fly-control.jpg"),
  boxelder: versionedAsset("/assets/images/boxelder-bug-control.jpg"),
  tick: versionedAsset("/assets/images/tick-control.jpg"),
  silverfish: versionedAsset("/assets/images/silverfish-control.jpg"),
  beetle: versionedAsset("/assets/images/beetle-control.jpg"),
  pantry: versionedAsset("/assets/images/pantry-pest-control.jpg"),
  earwig: versionedAsset("/assets/images/earwig-control.jpg"),
  stinkBug: versionedAsset("/assets/images/stink-bug-control.jpg"),
  otherPests: versionedAsset("/assets/images/other-pests.jpg"),
};
...
const services = [
  ...
  },
  {
    ...
    image: serviceImages.carpenterAnt,
  ...
  },
  {
    ...
    image: serviceImages.carpenterBee,
  ...
  },
  {
    ...
    image: serviceImages.silverfish,
  ...
  },
  {
    ...
    image: serviceImages.otherPests,
...
<div class="discount-modal" data-discount-modal hidden>
  ...
  <section class="discount-dialog" role="dialog" aria-modal="true" aria-labelledby="discount-title">
    ...
    <form class="discount-form" action="/api/contact" method="post" data-discount-form data-lead-form data-success-message="Thanks. Bugman Plus received your discount registration.">
      ...
      <label>Phone<input name="phone" type="tel" inputmode="tel" autocomplete="tel" placeholder="4165551234" pattern="(?:\\+?1[ .-]?)?(?:\\([2-9][0-9]{2}\\)|[2-9][0-9]{2})[ .-]?[0-9]{3}[ .-]?[0-9]{4}" title="Enter any Canadian 10-digit phone number. Dashes are optional." required></label>
